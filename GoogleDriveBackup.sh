...
#This script requires drive_linux and pigz installed. https://github.com/odeke-em/drive
...
#Multiple parts can be backed up simultaneously using "(tar -I pigz ... & tar -I pigz ...)", which will also ensure that all backups are completed before the upload starts.
...
rm ServerName-$_now.tar.gz #Removes local backup.